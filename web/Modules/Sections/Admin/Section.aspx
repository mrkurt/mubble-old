...
CodeFile="Section.aspx.cs" Inherits="Mubble.Web.Admin.Section" ValidateRequest="false" %>
...
<form runat="server"><asp:ValidationSummary CssClass="FormErrors" runat="server" DisplayMode="BulletList" EnableClientScript="true" HeaderText="Problems!  Please correct the following errors, oversights, and omissions." />
    ...
    <div id="AdvancedOptions" class="Expando Expanded">
        <h2 onclick="toggleParent(this, 'Expando', 'Expando Expanded');return false;">Listing Options</h2>
        <div class="OptionsContainer">
            <p>Show Content:<br /></p>
            <div class="ModulePicker" style="padding-left: 5px;">
            <admin:ModulePicker runat="server" ID="modulePicker" ShowWildCardControl="true" ModuleId='<%# Controller.Settings["ModuleId"] %>' />
            </div>
        </div>
    </div>
