...
{
    public class TriggerToKeepControllerTypesInSync_67 : ActiveObjects.Creator.Migrations.Base
    {
        public override void MigrateUp()
        {
            using (ActiveTable moduleControls = OpenTable("ModuleControls"))
            {
                ...
                moduleControls.AddTrigger("modulecontrols_trigger_UpdateControllerActiveObjectTypes",
                    ...
                    @"
    SET NOCOUNT ON;
    UPDATE Controllers SET ActiveObjectType=a.ControllerActiveObjectType, IsContent=a.IsContent, IsContentContainer=a.IsContentContainer FROM Inserted a, Controllers b
