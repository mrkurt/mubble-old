...
tinyMCE.importPluginLanguagePack('snippets', 'en');

// Singleton class
var TinyMCE_SnippetPlugin = {
	/**
	...
	getControlHTML : function(cn) {
		switch (cn) {
			case "snippet":
				return tinyMCE.getButtonHTML(cn, 'lang_snippets_desc', '{$pluginurl}/images/snippet.gif', 'mceSnippet', true);
		}
		...
		switch (command) {
			...
			case "mceSnippet":
				...
				if (user_interface) {
					...
					template['file'] = '../../plugins/snippets/popup.htm'; // Relative to theme
					template['width'] = 450;
					template['height'] = 400;
...
tinyMCE.addPlugin("snippets", TinyMCE_SnippetPlugin);